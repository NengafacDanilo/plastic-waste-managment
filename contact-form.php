...
<link rel="stylesheet" href="asset/css/contact.css ?<?php echo date('Y-m-d H:i:s') ?>">
...
<body>
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp TRANSCYCLE</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="index.php" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>ABOUT US</h6></a>
          </li>
    ...
    <div class="container contact-form" style="font-family: 'IBM Plex Sans', sans-serif;">
            ...
            <form method="post" action="contact.php">
                <h3>Drop Us a Feedback Message</h3>
               <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="tel" name="txtPhone" class="form-control" placeholder="Your Phone Number *" value="" minlength="9" maxlength="9" required />
                        </div>
                        <div class="form-group" >
